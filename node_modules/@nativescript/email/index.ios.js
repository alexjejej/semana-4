    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            if (message) {
                ...
                const isHTML = messageAsNSString.rangeOfStringOptions('<[^>]+>', 1024 /* RegularExpressionSearch */).location !== NSNotFound;
...
var MFMailComposeViewControllerDelegateImpl = /** @class */ (function (_super) {
    __extends(MFMailComposeViewControllerDelegateImpl, _super);
    function MFMailComposeViewControllerDelegateImpl() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MFMailComposeViewControllerDelegateImpl.initWithCallback = function (callback) {
        var delegate = MFMailComposeViewControllerDelegateImpl.new();
